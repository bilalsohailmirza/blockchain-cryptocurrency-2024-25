...
def store_hashes(leaf_nodes, root_hash):
    ...
    # We have implemented it here (21K-3161 | 21K-4554)
    temp_node = leaf_nodes[1] # we are logging of data2(user2's hash)
    temp_node_idx = leaf_nodes.index(temp_node)
    print(temp_node_idx)
    del leaf_nodes[temp_node_idx]
